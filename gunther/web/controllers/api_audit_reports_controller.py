...
from gunther.web.models.audit_report import AuditReport, DetailedAuditReport, GetAuditReport, UpdateAuditReport
...
async def update(dto: UpdateAuditReport, id: int = Path(ge=1)) -> AuditReport | None:
    with gunther_sessionmaker() as session:
